package com.mitmws.configuration;
...
public class ApplicationConfig {
    ...
    public void setDefaultConfig(Properties prop) {
        ...
        prop.setProperty("pki.cert_subject_st", "mitmws");
        prop.setProperty("pki.cert_subject_l", "mitmws");
        prop.setProperty("pki.cert_subject_o", "mitmws");
        prop.setProperty("pki.cert_subject_cn", "mitmws");
