...
import com.wsproxy.tester.AutomatedTestRun;
...
public class ProjectModel {
    ...
    private String getDefaultDb() throws IOException {
        File tmpSessionFile = File.createTempFile("wsproxy",".wspdb");
    ...
    public void load ( String wsproxyDbFile ) throws ProjectDataServiceException {
        reset();
        projectDataService = new ProjectDataService(wsproxyDbFile);
        ...
        eventEmitter.firePropertyChange("ProjectModel.wsproxyDbFile", null, wsproxyDbFile);

    }

    public void unload() throws ProjectDataServiceException {
        getProjectDataService().disconnect();
        eventEmitter.firePropertyChange("ProjectModel.wsproxyDbFile", null, null);
    }
