...
public final class NetUtils {
    ...
    public static String getRemoteUrl( String url, Proxy proxy ) throws IOException {
        ...
        urlConn.setRequestProperty("User-Agent", String.format("wsproxy/%s", VERSION.getVersionStr()));
    ...
    public static boolean testRemotePort ( String remoteAddr, int remotePort ) {
        ...
        Socket socket = null;
        try {
            socket = WsProxySocketFactory.getPlaintextSocket(remoteAddr,remotePort,null);
